...
![image](https://github.com/ivybarley/hybrid-student-engagement/blob/32dda52582b13ac9a15257dd56d4a1da511db4c0/images/PowerBI5.png)

Modules in the hybrid student engagement package include: 

1. [Pipelines](https://github.com/ivybarley/hybrid-student-engagement/tree/main/pipelines) for ingesting data from multiple sources into the data lake.
2. [Notebooks](https://github.com/ivybarley/hybrid-student-engagement/tree/main/notebooks) for cleaning, transforming, anonymizing and enriching data into the data warehouse.
3. [PowerBI templates](https://github.com/ivybarley/hybrid-student-engagement/tree/main/powerbi) for exploring, visualizing and deriving insights from the data.
